...
if __name__ == "__main__":
    ...
    parser.add_argument("--environment", type=str, default="Lift") # Lift TwoArmLift
    parser.add_argument("--robots", nargs="+", type=str, default=["Panda"], help="Which robot(s) to use in the env") # Panda ["Panda","Panda"]
    parser.add_argument(
        "--config", type=str, default="default", help="Specified environment configuration if necessary" # default parallel
    )
    ...
    env = suite.make(
        **config,
        ...
        render_camera="agentview",# "agentview",frontview, None
        ignore_done=True,
